/* 
    Given the pointer to the head node of a doubly linked list, reverse the order of the nodes in place. That is, 
    change the next and prev pointers of the nodes so that the direction of the list is reversed. 
...
class Result {
    ...
    public static DoublyLinkedListNode reverse(DoublyLinkedListNode llist) {
        ...
        while (temp != null) {
            DoublyLinkedListNode x = temp.next;
            temp.next = temp.prev;
            temp.prev = x;
            temp = temp.prev;
        }
